...
import { findMany } from "@/lib/server-actions/document-downloads";
import md5 from "md5";
...
function getSearchParams(data: Record<string, any>) {
  const SearchParams = z.object({
    documentId: z.optional(z.coerce.number()),
...
async function DataTablePage(props: { searchParams: Record<string, any> }) {
